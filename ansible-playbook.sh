...
# make ansible-playbook from container available on native shell
...
lima nerdctl exec -it ansible-development ansible-playbook ${CONTAINER_PATH}/${1} $2 $3 $4 $5 $6 $7 $8 $9
